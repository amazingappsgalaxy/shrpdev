// DEPRECATED: This script relies on a custom `exec_sql` RPC function which does not exist in the database.
// Please use the Supabase CLI to manage the database schema:
// npx supabase link --project-ref igsyhvrctnqntqujqfif
